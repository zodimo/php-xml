...
use Zodimo\Xml\Traits\ExiCallbackInfrastructure;
use Zodimo\Xml\Traits\HandlerInfrastructure;

/**
 * @implements ExiParserInterface<\Throwable>
 */
class ExiXmlParser implements ExiParserInterface, HasHandlers
{
    /**
    ...
    /**
     * @phpstan-use ExiCallbackInfrastructure<\Throwable>
     */
    use ExiCallbackInfrastructure;
    ...
    private function getHandlerForPath(string $path): Option
    {
        ...
        foreach ($this->callbacks[$nodeType] as $hpath => $callbackRegistrationId) {
            if (0 === strpos($path, $hpath)) {
